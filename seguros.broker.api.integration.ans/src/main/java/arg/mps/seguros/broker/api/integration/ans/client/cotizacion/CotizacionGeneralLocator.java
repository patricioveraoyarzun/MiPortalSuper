...
public class CotizacionGeneralLocator extends org.apache.axis.client.Service implements arg.mps.seguros.broker.api.integration.ans.client.cotizacion.CotizacionGeneral {
    ...
    public arg.mps.seguros.broker.api.integration.ans.client.cotizacion.CotizacionGeneralSoap_PortType getCotizacionGeneralSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public arg.mps.seguros.broker.api.integration.ans.client.cotizacion.CotizacionGeneralSoap_PortType getCotizacionGeneralSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            arg.mps.seguros.broker.api.integration.ans.client.cotizacion.CotizacionGeneralSoap12Stub _stub = new arg.mps.seguros.broker.api.integration.ans.client.cotizacion.CotizacionGeneralSoap12Stub(portAddress, this);
    ...
    public arg.mps.seguros.broker.api.integration.ans.client.cotizacion.CotizacionGeneralSoap_PortType getCotizacionGeneralSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public arg.mps.seguros.broker.api.integration.ans.client.cotizacion.CotizacionGeneralSoap_PortType getCotizacionGeneralSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            arg.mps.seguros.broker.api.integration.ans.client.cotizacion.CotizacionGeneralSoapStub _stub = new arg.mps.seguros.broker.api.integration.ans.client.cotizacion.CotizacionGeneralSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (arg.mps.seguros.broker.api.integration.ans.client.cotizacion.CotizacionGeneralSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                arg.mps.seguros.broker.api.integration.ans.client.cotizacion.CotizacionGeneralSoap12Stub _stub = new arg.mps.seguros.broker.api.integration.ans.client.cotizacion.CotizacionGeneralSoap12Stub(new java.net.URL(CotizacionGeneralSoap12_address), this);
                _stub.setPortName(getCotizacionGeneralSoap12WSDDServiceName());
                return _stub;
            }
            if (arg.mps.seguros.broker.api.integration.ans.client.cotizacion.CotizacionGeneralSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                arg.mps.seguros.broker.api.integration.ans.client.cotizacion.CotizacionGeneralSoapStub _stub = new arg.mps.seguros.broker.api.integration.ans.client.cotizacion.CotizacionGeneralSoapStub(new java.net.URL(CotizacionGeneralSoap_address), this);
                _stub.setPortName(getCotizacionGeneralSoapWSDDServiceName());
                return _stub;
            }
        }
