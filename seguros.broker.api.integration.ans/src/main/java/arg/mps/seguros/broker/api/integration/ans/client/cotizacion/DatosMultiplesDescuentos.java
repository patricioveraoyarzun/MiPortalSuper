...
public class DatosMultiplesDescuentos  implements java.io.Serializable {
    ...
    private arg.mps.seguros.broker.api.integration.ans.client.cotizacion.DatosDescuento empty;
    ...
    public DatosMultiplesDescuentos(
           ...
           arg.mps.seguros.broker.api.integration.ans.client.cotizacion.DatosDescuento empty) {
     ...
     * @return empty
     */
    public arg.mps.seguros.broker.api.integration.ans.client.cotizacion.DatosDescuento getEmpty() {
        return empty;
    }
     ...
     * @param empty
     */
    public void setEmpty(arg.mps.seguros.broker.api.integration.ans.client.cotizacion.DatosDescuento empty) {
        this.empty = empty;
    }
